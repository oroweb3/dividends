...
export function DelegationControl({wallet}:{wallet:string}){
 ...
 return <div className="panel automation-panel">
  ...
  <p className="small-note">{status?.executionEnabled?'Automatic processing is available for tracked dividends that pass eligibility checks. Granting permission allows conversions without further signature prompts.':'Automatic conversion is not enabled yet. Granting permission does not start conversions or sell anything now.'}</p>
